...
import {useUserService} from "../../services/UserService/UseUserService.ts";
import {LoginPageContext} from "./LoginPage.store.ts";
                        ...
                        >
                            ...
                            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
                                ...
                                <Grid container justifyContent="center" alignItems="center">
                                    <Grid item>
                                        <Link onClick={() => navigate(RoutesConstants.RegisterRoute)} variant="body2">
